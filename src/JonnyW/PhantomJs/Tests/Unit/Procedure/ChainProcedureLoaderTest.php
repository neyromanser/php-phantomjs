...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    {
        $procedureLoader = $this->getMockBuilder('\JonnyW\PhantomJs\Procedure\ProcedureLoaderInterface')
            ->getMock();
    ...
    {
        $procedure = $this->getMockBuilder('\JonnyW\PhantomJs\Procedure\ProcedureInterface')
            ->getMock();
